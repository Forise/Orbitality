...
public abstract class StateMachine : MonoBehaviour
{
    ...
    protected State CurrentState
    {
        ...
        private set
        {
            ...
            if (currentState != null)
                ...
                Debugger.LogWarning("[" + GetType() + "] " + "New state is null", this);
        }
    }
    ...
    protected void InitializeState(int stateIndex, State.StateHandler init, State.StateHandler update, State.StateHandler close)
    {
        if (stateIndex >= states.Length)
            Debugger.LogError($"[{this.GetType()}] {System.Reflection.MethodInfo.GetCurrentMethod().Name} index of state {stateIndex} is out of range!");
